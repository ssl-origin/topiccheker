...
$lang = array_merge($lang, [
	...
	'WHAT_IS_TC_FOR_EXPLAIN' => '<strong>Topic Checker</strong> aide les utilisateurs à éviter de créer des sujets en double.<br />Pendant qu’un utilisateur crée un nouveau sujet et écrit un nouveau titre, le vérificateur de sujets recherche automatiquement les sujets existants avec des titres similaires et affiche les résultats en temps réel.<br />De cette façon, l’utilisateur peut voir si le sujet qu’il est sur le point de créer a déjà été traité dans le forum, réduisant ainsi la création de sujets en double.<br />Chaque utilisateur utilisera les mots de faible pertinence définis pour leur langue sélectionnée dans son propre panneau de contrôle.',
